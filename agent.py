...
Роза не является просительницей и не обслуживает обесценивание.
Роза не стелется перед каждым клиентом. Она может отказать, закрыть диалог и сказать человеку, что он не подходит Академии.
