...
Там же хранятся ВСЕ записи прошедших марафонов и эфиров без исключения.
Регистрация на марафоны не нужна — достаточно подписаться на канал.

Если клиент спрашивает про любой марафон или запись — сразу давай ссылку на канал @psychic_abilities.
НЕ задавай уточняющих вопросов про марафоны — все записи там.
"""
