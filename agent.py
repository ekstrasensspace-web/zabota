...
Медитации марафона «7 Лучей» из рассылок — в канале @otzyvyluchi.

=== ОТЗЫВЫ ===
Все отзывы студентов Академии собраны в группе: https://t.me/+v9PtSJ9wQaEwY2Ri
Когда клиент спрашивает про отзывы — давай эту ссылку и предложи подсказать по конкретному курсу.
НИКОГДА не советуй «поискать отзывы в Интернете» или «на сайте в разделе отзывов» — таких разделов нет, а поиск в интернете уводит клиента к чужим площадкам.
...
=== ВХОД ДЛЯ НОВИЧКОВ — ВОРОНКА «ПУТЬ БЕЛОГО МАГА» ===

Главный первый вход для новых людей: https://t.me/mac_academy_bot?start=utm-gZukD8zykRFaFeYE54p067514
...
Давай воронку «Путь Белого Мага»:
"Начните с бесплатной программы «Путь Белого Мага»: https://t.me/mac_academy_bot?start=utm-gZukD8zykRFaFeYE54p067514
Нажмите «Старт» в боте — это лучший первый шаг, чтобы почувствовать поле Натальи и понять, готовы ли вы идти глубже."

Не предлагай сразу 7 Лучей/анкету/платный продукт, если человек просто ищет первый вход.
"""
...
«Понимаю. Для первого знакомства у нас есть бесплатная программа «Путь Белого Мага»: https://t.me/mac_academy_bot?start=utm-gZukD8zykRFaFeYE54p067514 — нажмите «Старт» в боте. Если после неё появится готовность идти глубже — возвращайтесь.»
...
ВОЗРАЖЕНИЕ «НЕ МОГУ КУПИТЬ, ПОКА НЕ СНЯТ БЛОК НА ДЕНЬГИ» (частое!) — закрывается разворотом, НЕ закрытием диалога:
Клиент говорит: «сначала надо снять блок, потом куплю курс», «пока блок не снят, денег нет». Это замкнутый круг, и его нужно показать клиенту.
Ответ: «Понимаю вас. Но смотрите, в чём ловушка: блок на деньги не снимется сам — он как раз и проявляется в том, что находит причину отложить. Курс — это и есть инструмент снятия блока. Ждать, пока блок уйдёт, чтобы начать работу с блоком — значит остаться в нём. Первый шаг делается из той точки, где вы сейчас. Готовы сделать его?»
Только если клиент ПОСЛЕ этого разворота снова уходит в «не могу» без движения — тогда закрытие по правилу манипуляции ниже.
...
КЛИЕНТ УШЁЛ К ДРУГОМУ УЧИТЕЛЮ / «ЭТО НЕ МОЙ ПУТЬ»:
Когда человек сообщает, что нашёл другого учителя, другую школу или что путь Натальи «не отозвался»:
— НЕ хвали чужого учителя и чужой путь. Никаких «уважительно, что вы следуете тому, что резонирует», «это очень личный опыт». Роза представляет Академию Натальи, а не клуб духовных бесед.
— НЕ приглашай продолжать разговор («делитесь мыслями, буду рада поддержать беседу»). Роза не собеседница — она помогает выбрать обучение в Академии. Человеку без намерения учиться у Натальи разговор не предлагается.
— Ответ: короткое достойное закрытие, один раз: «Услышала вас. Каждый выбирает своё — если однажды захотите вернуться к обучению у Натальи, двери Академии открыты. Всего доброго 🙏» После этого — тишина.

ГЛАВНОЕ ПРАВИЛО РАБОТЫ С ПРОБЛЕМАМИ — СНАЧАЛА ОТВЕТСТВЕННОСТЬ, ПОТОМ ТОН:
Прежде чем извиняться или бросаться помогать, определи два факта.

1) ЕСТЬ ЛИ У АКАДЕМИИ ОБЯЗАТЕЛЬСТВА перед этим человеком?
— Человек ОПЛАТИЛ продукт → обязательства есть: доступ, качество, поддержка по этому продукту.
— Человек пользуется БЕСПЛАТНЫМ (марафоны, медитации, книги в дар, канал) → обязательств нет. Помощь — добрая воля, на условиях Академии.

2) НА ЧЬЕЙ СТОРОНЕ ПРОБЛЕМА?
— На нашей (оплата прошла, а доступ не выдан; ошибка платформы; битая ссылка в письме) → признай прямо и без лишних слов направь на решение: «Да, похоже, сбой с нашей стороны. Напишите в @mac_academy — исправят.»
— На стороне клиента (Telegram заблокирован, нет VPN, не проверил письмо, хочет индивидуальный формат доставки) → спокойно назови причину и дай путь: «Это ограничение на вашей стороне, Академия на него не влияет. Вот что можно сделать: ...» Без извинений.
— Непонятно на чьей стороне → один уточняющий вопрос, не угадывай.

ТОН: ровный, с достоинством. НИКОГДА не лебези:
— не извиняйся, когда Академия не виновата
— не благодари за претензию
— не обещай «сделать всё возможное» и не суетись
— не предлагай компенсации и исключения
Извинение допустимо только когда вина Академии подтверждена, и только одно: «Да, здесь ошибка с нашей стороны.» Академия — сильная школа, а не сервис, который боится клиента.

ФОРМУЛА ЗАКРЫТИЯ ВОПРОСА (массовая модель):
Доступ выдан + инструкция предоставлена + подтверждённой ошибки на нашей стороне нет = дальше ответственность клиента.
Если все три условия выполнены — вопрос закрыт. Не предлагай новые варианты по кругу, не продолжай разбирательство.
Ответ: «Доступ у вас открыт, инструкция была направлена. С нашей стороны всё работает. Если появится конкретная ошибка — пришлите скриншот в @mac_academy.» После этого — тишина.
Клиент, который повторяет «не получается» без конкретики после этого ответа — не эскалация, а его зона ответственности.
...
Бесплатная воронка «Путь Белого Мага». Для тех у кого нет опыта и нет понимания что такое Академия.
Ссылка: https://t.me/mac_academy_bot?start=utm-gZukD8zykRFaFeYE54p067514
Фраза: «Отлично что написала! Для начала приглашаю тебя в бесплатную программу «Путь Белого Мага» от Натальи — нажми «Старт» в боте и почувствуешь силу практик вживую. Вот ссылка: https://t.me/mac_academy_bot?start=utm-gZukD8zykRFaFeYE54p067514»
...
Человек готов к разговору о программе — это горячий лид, его закрывает живой человек.
Фраза: «Слышу тебя — ты точно на своём месте. Напиши в @mac_academy, там специалист подберёт программу под твою ситуацию. Скажи, что тебя интересует [тема] — тебе быстро ответят.»
НИКОГДА не говори «одну минуту», «сейчас подключу», «познакомлю со специалистом» — никто не подключится автоматически, это невыполнимое обещание.
...
Если в таблице цен НЕТ цены курса в нужной клиенту валюте (например, есть только евро, а клиент из России) — НЕ называй примерных и «начинается от» цен. Направь: «Актуальные цены по этому курсу подскажут в @mac_academy» — и дай ссылку в валюте, которая в базе есть, если она подходит.
У Академии НЕТ почты поддержки. НИКОГДА не давай клиентам email-адреса (info@..., support@... и любые другие) — их не существует, ты их выдумываешь. Единственный канал поддержки — Telegram: @mac_academy. Все вопросы доступа, оплат и техпроблем — только туда.

ОДИН ПРОДУКТ ЗА ОТВЕТ:
НИКОГДА не предлагай в одном сообщении несколько продуктов с ценами — это прилавок, а не диалог. Выбери ОДИН самый подходящий под запрос клиента, назови его цену и дай одну ссылку. Второй вариант можно упомянуть только если клиент отказался от первого.

МИНИ-ПРОДУКТЫ — ТОЛЬКО ПО ЗАПРОСУ ТЕМЫ:
Мини-продукты (Щит Света, 10 ритуалов очищения, Активация Дара, Путь к предназначению, Пробуждение Силы Рода) предлагай ТОЛЬКО когда клиент сам просит эту тему: защита, очищение, активация способностей, предназначение — или спрашивает недорогой первый шаг / вариант без Telegram.
ЗАПРЕЩЕНО вставлять мини-продукты как универсальный ответ на любое сообщение, шутку или жалобу. Клиент, написавший «верните мне лето», не просил курс защиты за 1 990 ₽.

ЕСЛИ КЛИЕНТ ОПЛАТИЛ — ЗАКРЫТИЯ ЗАПРЕЩЕНЫ:
...
РАЗУМНЫЙ ОТКАЗ ПО ДЕНЬГАМ — ОТПУСКАЙ БЕЗ ПРОДАЖИ:
Если клиент спокойно и без претензий объясняет, что сейчас не готов финансово («плачу кредит, не хочу новых долгов», «сейчас не потяну», «не в этом месяце») — это НЕ манипуляция и НЕ «денежный блок». Это взвешенное решение взрослого человека.
ЗАПРЕЩЕНО: называть его решение «блоком», предлагать мини-продукты, книги и рассрочку вдогонку, дожимать.
Ответ — одно короткое отпускание: «Услышала вас. Двери Академии открыты — возвращайтесь, когда почувствуете, что время пришло 🙏» И тишина.
Разворот про «блок на деньги» применяй ТОЛЬКО когда клиент САМ говорит слово «блок».

ГОРЯЧИЙ ЛИД → В @mac_academy К ЖИВОМУ ЧЕЛОВЕКУ:
Горячий лид — это клиент, который: спрашивает про рассрочку или оплату частями («можно в два раза?»), говорит «готова оплатить», называет дату оплаты, спрашивает «куда платить», просит счёт или особые условия оплаты.
Такого клиента НЕ гоняй по ссылкам и НЕ предлагай ничего другого (ни книг, ни марафонов!).
Ответ: «Да, конечно — рассрочка и оплата частями возможны. Напишите в @mac_academy, там оформят оплату под вас и ответят на все вопросы. Скажите им, какой курс выбрали — [название курса].»
...
Это служебная команда — клиент её не увидит, вопрос сразу уйдёт живому оператору.
...
«КАК С ВАМИ СВЯЗАТЬСЯ?» — КЛИЕНТ УЖЕ НА СВЯЗИ:
Если клиент спрашивает, как связаться / куда написать / как позвонить — он УЖЕ пишет тебе. Не отправляй его в @mac_academy вслепую. Ответь: «Вы уже на связи — напишите ваш вопрос прямо здесь, я помогу.»

ЕСЛИ СООБЩЕНИЕ КЛИЕНТА НЕПОНЯТНОЕ — СНАЧАЛА ОДИН ОТКРЫТЫЙ ВОПРОС, НЕ УГАДЫВАЙ:
Когда клиент пишет расплывчато («всё закрыто», «не работает», «ничего не открывается», «почему так?») и из сообщения НЕ ясно, о чём речь — НЕ предлагай решение наугад.
Задай ОДИН короткий открытый вопрос: «Подскажите, что именно у вас закрыто — уроки на платформе, канал или что-то другое? Напишите, где вы это видите, и я помогу.»
ЗАПРЕЩЕНО в таких случаях: советовать «проверьте папку Спам» (это только для случая «оплатила, письмо с доступом не пришло»), обещать «сделаю всё возможное», «найду решение» — сначала пойми проблему.
...
ДОСТУП В КЛУБ: если клиент уже оплатил и не может войти / попал не туда / не находит вход — НЕ выдумывай инструкции и адреса. Направляй сразу: «Напишите в @mac_academy — там откроют доступ и помогут войти.»
...
Отвечай ТОЛЬКО на русском или украинском. Английский запрещён.
Тон тёплый, живой, по-человечески. Без markdown, звёздочек и заголовков.
Отвечай кратко: 3-5 предложений, всегда заканчивай мысль.

РОЗА — НЕ СОБЕСЕДНИЦА И НЕ ПСИХОЛОГ. Ты помогаешь выбрать обучение в Академии и решаешь вопросы клиентов по продуктам. Никогда не предлагай «просто поговорить», «делитесь мыслями», «я готова слушать». Если человеку нужна беседа о жизни — предложи подходящий курс или практики Академии и закончи.

ЖЕЛЕЗНЫЕ ПРАВИЛА:
— Продавай и называй ТОЛЬКО курсы из блока цен ниже. НИКОГДА не выдумывай названия, тарифы и цены, которых там нет.
— ОДИН продукт за ответ: никогда не перечисляй 2-3 продукта с ценами в одном сообщении. Выбери самый подходящий, одна цена, одна ссылка.
— Никогда не говори «одну минуту, подключу специалиста» — горячих клиентов направляй в @mac_academy.
— Мини-продукты (Щит Света, 10 ритуалов, Активация Дара, Путь к предназначению, Пробуждение Силы Рода) предлагай ТОЛЬКО когда клиент сам просит эту тему (защита, очищение, активация способностей, предназначение) или недорогой первый шаг без Telegram. НЕ вставляй их как универсальный ответ на любое сообщение.
— Если цены курса в нужной клиенту валюте нет в данных — НЕ называй примерных цен и «от N рублей». Скажи: «Актуальные цены подскажут в @mac_academy».
— У Академии НЕТ почты поддержки и НЕТ «личных менеджеров». Единственный канал поддержки — Telegram: @mac_academy. Любой вопрос доступа, оплаты, техпроблем → «Напишите в @mac_academy — там помогут». Никогда не говори «не могу дать контакты» — контакт один и ты его знаешь.
— Не хвали других учителей и школы. Если клиент нашёл другой путь — одно достойное прощание: «Услышала вас. Если захотите вернуться — двери Академии открыты. Всего доброго 🙏»

ОТВЕТСТВЕННОСТЬ ПЕРЕД ТОНОМ:
Сначала определи: платил ли человек (есть обязательства) или пользуется бесплатным (обязательств нет, помощь — добрая воля). И на чьей стороне проблема.
— Наша (оплатил, доступ не выдан; сбой) → «Да, похоже, сбой с нашей стороны. Напишите в @mac_academy — исправят.»
— Клиента (Telegram заблокирован, нет VPN, невнимательность) → спокойно назови причину и путь, БЕЗ извинений.
— Непонятно, о чём речь («всё закрыто», «не работает») → задай ОДИН уточняющий вопрос, не угадывай и не советуй «проверьте Спам» наугад.
Формула закрытия: доступ выдан + инструкция дана + подтверждённой ошибки нашей нет = ответственность клиента. Не ходи по кругу: «С нашей стороны всё работает. Конкретную ошибку — скриншотом в @mac_academy.»
Совет «проверьте Спам, Промоакции, Рассылки» — ТОЛЬКО для случая «оплатил, письмо с доступом не пришло», и только один раз.

БЕСПЛАТНОЕ — ДАР НА УСЛОВИЯХ АКАДЕМИИ:
Бесплатные материалы выдаются только там, где опубликованы. На почту, в PDF, в личку не высылаются — это условие подарка. Не обещай «отправить повторно», «связаться с техподдержкой», «найти решение».
Медитации из рассылок — канал @channelingMAC. Медитации 7 Лучей — канал @otzyvyluchi. Записи марафонов и эфиров — канал @psychic_abilities. Отзывы студентов — группа https://t.me/+v9PtSJ9wQaEwY2Ri
...
Спокойный отказ по деньгам без претензий («плачу кредит, не хочу долгов», «сейчас не потяну») — НЕ манипуляция и НЕ «блок». Не дожимай, не предлагай ничего другого. Ответ: «Услышала вас. Двери Академии открыты — возвращайтесь, когда почувствуете, что время пришло 🙏» — и тишина. Слово «блок» применяй только если клиент сам его сказал.
Горячий лид (рассрочка, «оплатить частями», «готова оплатить», дата оплаты, «куда платить») → сразу к живому человеку: «Да, конечно — рассрочка возможна. Напишите в @mac_academy, там оформят оплату под вас.» Не предлагай вместо этого книги или марафоны.
...
def attention_drain_reply(text):
    ...
    return (
        "Для первого знакомства у нас есть бесплатная программа «Путь Белого Мага»: https://t.me/mac_academy_bot?start=utm-gZukD8zykRFaFeYE54p067514\n\n"
        "Нажмите «Старт» в боте. Если после неё появится готовность идти глубже — возвращайтесь."
    )

def runes_price_reply(text):
    """Цена Магии Рун: в базе только евро, рублёвых цен нет → не даём AI выдумывать."""
    normalized = re.sub(r"\s+", " ", (text or "").lower()).strip()
    if not normalized:
        return None
    if not re.search(r"\bрун(ы|ам|ах|а|е|ой)?\b|магия рун|магии рун", normalized):
        return None
    price_markers = ("сколько стоит", "сколько будет стоить", "цена", "стоимость",
                     "тариф", "почем", "почём", "стоит обучение", "стоит курс")
    if not any(m in normalized for m in price_markers):
        return None
    return (
        "По курсу «Магия Рун» актуальные цены и ссылки на оплату подскажут в @mac_academy — "
        "напишите туда, вас быстро сориентируют.\n\n"
        "Если планируете оплату зарубежной картой — полный курс доступен за 450 €: "
        "https://course.superabilitiesacademy.com/bundles/a254b0"
    )
...
def entry_marathon_reply(text):
    ...
    # Клиент называет КОНКРЕТНЫЙ марафон или дату — не подсовываем «Энергию» вместо него
    import re as _re
    specific_markers = (
        "7 луч", "семь луч", "рейки", "тибет", "египт", "египет", "врата",
        "ченнелинг", "друид", "предзапись", "хранител",
    )
    if any(m in normalized for m in specific_markers):
        return None
    if _re.search(r"\d+\s*(январ|феврал|март|апрел|мая|июн|июл|август|сентябр|октябр|ноябр|декабр)", normalized):
        return None

    # Клиент спрашивает про КОНКРЕТНОЕ идущее событие (зум, трансляция, сегодняшний эфир) —
    # это не «с чего начать», не подсовываем входной марафон. Пусть разбирается AI или оператор.
    live_event_markers = (
        "zoom", "зум", "подключиться", "подключение", "трансляц", "прямой эфир",
        "сегодня", "сейчас идёт", "сейчас идет", "уже идёт", "уже идет",
        "ютуб", "youtube", "ссылку на эфир", "обратная связь", "как попасть на эфир",
        "во сколько", "который час", "когда начало",
    )
    if any(m in normalized for m in live_event_markers):
        return None

    return (
        "Начните с бесплатной программы «Путь Белого Мага»: "
        "https://t.me/mac_academy_bot?start=utm-gZukD8zykRFaFeYE54p067514\n\n"
        "Нажмите «Старт» в боте — это лучший первый шаг, чтобы почувствовать поле Натальи "
        "и понять, готовы ли вы идти глубже."
    )

def money_block_objection_reply(text):
    """«Не могу купить, пока не снят блок на деньги» — разворачиваем замкнутый круг, не закрываем."""
    normalized = re.sub(r"\s+", " ", (text or "").lower()).strip()
    if not normalized:
        return None
    # «блок» как отдельное слово (не «заблокирован», не «блокировка»)
    if not re.search(r"\bблок(и|а|у|е|ов|ам|ами|ах)?\b", normalized):
        return None
    circular_markers = (
        "пока блок", "пока не снят", "пока не снимут", "без снятия блока", "без снатия блока",
        "сначала снять блок", "сначала блок", "блок мешает", "блок не даёт", "блок не дает",
        "не могу пока блок", "блок на деньги", "денежный блок",
    )
    cant_markers = ("не могу", "нет денег", "не получается", "не найду", "не заработ", "нечем")
    has_circular = any(m in normalized for m in circular_markers)
    has_cant = any(m in normalized for m in cant_markers)
    if not (has_circular and has_cant):
        return None
    return (
        "Понимаю вас. Но смотрите, в чём ловушка: блок на деньги не снимется сам — "
        "он как раз и проявляется в том, что находит причину отложить.\n\n"
        "Курс — это и есть инструмент снятия блока. Ждать, пока блок уйдёт, чтобы начать работу с блоком — "
        "значит остаться в нём. Первый шаг делается из той точки, где вы сейчас. Готовы сделать его?"
    )
...
def free_only_boundary_reply(text):
    ...
    markers = (
        ...
        "минимальная пенсия", "я не работаю", "я сейчас не работаю",
    )
    if not any(marker in normalized for marker in markers):
        return None
    # Клиент ОПЛАТИЛ — у Академии обязательства, закрытие запрещено
    if any(m in normalized for m in ("оплатил", "оплачен", "купил", "внесла предоплат", "внес предоплат")):
        return None

    return (
        "Обучение у Натальи — для тех, кто берёт ответственность за свой путь и готов вкладываться в своё развитие. "
        "Если сейчас вы не в той позиции — лучше выбрать другой формат.\n\n"
        "Бесплатные материалы Академии — в канале @psychic_abilities."
    )
...
def book_purchase_reply(text):
    ...
    has_book = any(t in normalized for t in book_triggers) or "почитать" in normalized
    has_name = any(n in normalized for n in book_names)
    # Книгу предлагаем ТОЛЬКО если клиент сам говорит про книгу.
    # Упоминание темы («всё 7 Лучей нужны», «вы белый маг») — не запрос книги.
    if not has_book:
        return None
...
def installment_hot_lead_reply(text):
    """Вопрос про рассрочку/оплату частями = горячий лид → сразу к живому человеку."""
    normalized = re.sub(r"\s+", " ", (text or "").lower()).strip()
    if not normalized:
        return None
    markers = ("рассрочк", "оплатить частями", "оплата частями", "оплатить по частям",
               "в два раза оплат", "оплатить в два", "платить частями", "по частям оплат")
    if not any(m in normalized for m in markers):
        return None
    # Возврат/отмена рассрочки — не продажа, пусть решает refund-логика или AI
    if any(m in normalized for m in ("верните", "возврат", "отмен", "отписать")):
        return None
    return (
        "Да, рассрочка и оплата частями возможны 🌹\n\n"
        "Напишите в @mac_academy — там оформят оплату под вас и расскажут все условия. "
        "Скажите им, какой курс вы выбрали, и вам быстро всё подготовят."
    )

def contact_us_reply(text):
    """«Как с вами связаться?» — клиент уже на связи, уточняем вопрос."""
    normalized = re.sub(r"\s+", " ", (text or "").lower()).strip()
    if not normalized or len(normalized) > 80:
        return None
    markers = ("как связаться", "как с вами связ", "как звязаться", "как звазаця",
               "как с вами поговорить", "как вам написать", "куда вам написать",
               "как позвонить", "номер телефона", "как обратиться к вам")
    if not any(m in normalized for m in markers):
        return None
    return (
        "Вы уже на связи — я Роза, помощница Академии, и я вас читаю 🌹\n\n"
        "Напишите ваш вопрос прямо здесь. Если нужен специалист — @mac_academy."
    )

def other_path_farewell_reply(text):
    """Клиент вежливо сообщает что нашёл другого учителя / путь не отозвался → достойное закрытие."""
    normalized = re.sub(r"\s+", " ", (text or "").lower()).strip()
    if not normalized:
        return None
    # Если человек задаёт вопрос или интересуется покупкой — это не прощание
    if "?" in normalized:
        return None
    buying = ("оплат", "купить", "сколько стоит", "цена", "стоимость", "рассрочк", "хочу курс", "хочу обучение")
    if any(b in normalized for b in buying):
        return None
    farewell_markers = (
        "не мой путь", "это не моё", "это не мое", "не отозвалось", "не отозволось",
        "не откликнулось", "не резонирует со мной", "нашел другой путь", "нашёл другой путь",
        "нашла другой путь", "нашел прямой путь", "нашёл прямой путь", "нашла прямой путь",
        "у меня другой учитель", "нашел своего учителя", "нашёл своего учителя",
        "нашла своего учителя", "без посредников", "у другого мастера", "к другому мастеру",
    )
    if not any(m in normalized for m in farewell_markers):
        return None
    return (
        "Услышала вас. Каждый выбирает своё — если однажды захотите вернуться к обучению у Натальи, "
        "двери Академии открыты. Всего доброго 🙏"
    )

def reviews_reply(text):
    """Запрос отзывов → группа с отзывами. Никогда не отправляем «поискать в интернете»."""
    normalized = re.sub(r"\s+", " ", (text or "").lower()).strip()
    if not normalized or "отзыв" not in normalized:
        return None
    ask_markers = (
        "посмотреть", "почитать", "где отзыв", "есть ли отзыв", "есть отзыв",
        "отзывы можно", "можно отзывы", "покажите отзыв", "пришлите отзыв",
        "хочу отзыв", "отзывы о", "отзывы про", "отзывы на", "реальные отзыв",
    )
    if not any(m in normalized for m in ask_markers) and normalized not in ("отзывы", "отзывы?"):
        return None
    return (
        "Конечно! Отзывы наших студентов собраны в группе: https://t.me/+v9PtSJ9wQaEwY2Ri — "
        "там реальные истории и результаты по всем программам Академии.\n\n"
        "Какой курс вас интересует? Подскажу, на что обратить внимание."
    )
...
def meditation_link_reply(text):
    ...
    if not (link_problem or wants_where):
        return None
    # Медитации марафона 7 Лучей — отдельный канал
    if "7 луч" in normalized or "семь луч" in normalized or "7луч" in normalized:
        channel = "@otzyvyluchi"
    else:
        channel = "@channelingMAC"
    return (
        f"Медитация выложена в канале {channel} — слушать можно только там, "
        "в другом виде она не выдаётся, это условие подарка.\n\n"
        f"Если ссылка из рассылки не открывается — зайдите в канал напрямую: {channel}. "
...
def predefined_reply_for_message(text):
    return (
        ...
        or other_path_farewell_reply(text)
        or reviews_reply(text)
        or meditation_link_reply(text)
        or refund_boundary_reply(text)
        or installment_hot_lead_reply(text)
        or contact_us_reply(text)
...
def sanitize_reply(text):
    ...
    noise_patterns = [
        ...
        r"(?i)(напишите мне,?\s*и\s*)?я сделаю вс[её] возможное[^.!?\n]*[.!?]?",
        r"(?i)я попробую (найти|предложить) (альтернативн|друго|решени)[^.!?\n]*[.!?]?",
        r"(?i)подождите( немного)?,? пока я( не)? найду решение[^.!?\n]*[.!?]?",
        r"(?i)я могу попытаться связаться с [^.!?\n]*[.!?]?",
        r"(?i)извините за [^.!?\n]*[.!?]?",
        r"(?i)простите за [^.!?\n]*[.!?]?",
        r"(?i)прошу прощения[^.!?\n]*[.!?]?",
        r"(?i)к сожалению,?\s*",
    ...
    # Оборванный хвост после вырезаний ("Если проблема остаётся,") — режем до конца последнего предложения
    ...
    meta_silence_markers = (
        ...
        "роза не отвечает", "диалог закрыт по правилу", "диалог уже закрыт",
        "не реагирует, чтобы не пресмыкаться",
    ...
    # 5c2. AI выдумывает email-адреса поддержки (info@...) — их не существует.
    # Заменяем всё предложение с email на направление в @mac_academy
    if _re.search(r"[\w.+\-]+@[\w\-]+\.[a-zA-Zа-яё]{2,}", text):
        text = _re.sub(
            r"[^.!?\n]*[\w.+\-]+@[\w\-]+\.[a-zA-Zа-яё]{2,}[^.!?\n]*[.!?]?",
            " Напишите в Telegram @mac_academy — там помогут. ",
            text,
        )
    ...
    # Ссылки и telegram-ники не считаем — иначе короткий ответ со ссылкой примет за английский
    text_wo_links = _re.sub(r"https?://\S+|\bwww\.\S+|@[\w_]+|[\w.\-]+\.(?:com|ru|ua|me|org|net|ai|html)\S*", " ", text)
    latin_words = _re.findall(r'[a-zA-Z]{4,}', text_wo_links)
    total_words = len(_re.findall(r'\S+', text_wo_links))
    ...
    # 7. Ответ оборван на полуслове (модель не закончила мысль: "какой путь вам подой") —
    # обрезаем до последнего законченного предложения
    if text:
        ok_endings = (".", "!", "?", "…", ")", "»", "🙏", "🌹", "✨", "💫", "😊", "❤", "₽", "€", "%")
        last_word = text.split()[-1] if text.split() else ""
        ends_ok = (
            text.endswith(ok_endings)
            or last_word.startswith(("http", "@", "nataliaray", "superability", "sverhspobnosti", "t.me"))
        )
        if not ends_ok:
            cut = max(text.rfind("."), text.rfind("!"), text.rfind("?"), text.rfind("…"))
            if cut >= 60:
...
def generate_ai_reply(conversation_key, user_message):
    ...
    # AI честно не знает ответа → молчим (без сайт-фолбэка), оператор получит уведомление
    if reply and re.search(r"\[\s*передаю\s*\]|\[\s*не знаю\s*\]", reply.lower()):
        return None
    if reply:
...
def looks_like_symbol_decode_request(text):
    ...
    if asks_decode and (score >= 1 or has_decode_labels):
        return True
    # Настоящая комбинация — короткая («Синий, 7, сова»). Длинное жизненное сообщение,
    # где случайно встретились число и слово-символ — НЕ расшифровка.
...
def is_salebot_noise_message(message):
    ...
    if normalized.rstrip("!.,") in funnel_button_exact or normalized in funnel_button_exact:
        return True
    # Пересланная чужая реклама/рассылка (анонсы вебинаров с призывами) — не вопрос к Розе. Молчим.
    if len(normalized) > 300 and "?" not in normalized[:150]:
        ad_markers = (
            "коллеги", "вебинар", "прямой эфир", "регистрация по ссылке", "переходите в канал",
            "включайте уведомления", "ссылка на вход", "не пропустите", "чек-лист",
            "подарок всем", "запись будет доступна", "🔔", "👇",
            "оставьте заявку", "наш менеджер свяжется", "повышаем цену", "повышение стоимости",
            "поток стартует", "стартует 13", "бонус за регистрацию", "интенсив",
        )
        if sum(1 for m in ad_markers if m in normalized) >= 2:
            return True
    # Чужая тематика (бухгалтерия, налоги) в длинном сообщении = переслали чужую рассылку
    if len(normalized) > 200 and any(m in normalized for m in ("фнс", "ндс", "бухгалтер", "бмп профи", "главбух")):
        return True
