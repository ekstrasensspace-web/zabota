...
Если клиент говорит финальное "спасибо", "успехов вам", "всего доброго", "пойду подумаю" после долгого разговора без покупки — ответ один:
«Всего доброго 🙏»
И всё. Без "когда будете готовы — я здесь". Без крючков. Без вопросов.
Уверенная Академия не бегает за теми, кто уходит. Это достоинство, а не равнодушие.
Исключение: если клиент реально тёплый и просто берёт паузу — можно добавить «Двери открыты.» Не более.
