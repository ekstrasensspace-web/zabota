...
def generate_symbol_decode_reply(user_message, language="auto"):
    ...
    symbol_system = (
        ...
        + language_rule +
        "Напиши ответ в 4 коротких абзацах, без markdown и звёздочек:\n"
        "1. Расшифруй цвет, цифру и символы как качества и дары души — тепло и вдохновляюще.\n"
        "2. Определи ОДИН архетип из списка, который лучше всего соответствует этой комбинации: "
        "Проводник, Целитель, Воин Света, Маг, Учитель, Хранитель знаний. "
        "Назови его и объясни выбор одним предложением.\n"
        "3. Порекомендуй курс по архетипу (строго по таблице):\n"
        ...
        "Скажи: напишите нам, чтобы узнать подробности о курсе.\n"
        "Не ставь диагнозы, не обещай исцеление, не используй markdown и звёздочки."
    )
