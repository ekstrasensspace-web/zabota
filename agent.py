...
ШАГ 1 — Попроси проверить: Спам, Промоакции, Рассылки, Все письма + поиск по словам «доступ», «Академия», «GetCourse». Письмо приходит в течение 10-15 минут.
Шаблон: "Понимаю! Проверьте, пожалуйста, папки Спам, Промоакции, Рассылки и Все письма, а также поиск по словам «доступ» или «GetCourse». Если проверили и письма нет — напишите мне, передам специалисту."
ШАГ 2 — Если клиент подтвердил что проверил все папки и письма нет: скажи только "Передаю специалисту на ручную проверку 🙏" — и больше ничего не добавляй. НЕ проси снова проверить папки.
