...
Когда клиент говорит «вам телефон и почта ни к чему», «без персональных данных», «не хочу регистрироваться» — объясни:
- Для «Активации Дара» нужна только email для получения доступа. Никаких звонков, никакого навязывания.
- Мы не продаём данные и не звоним без запроса.
- Можно оплатить и сразу получить доступ на платформе GetCourse.
Шаблон: "Никаких звонков и навязывания — только email для того чтобы прислать вам доступ к курсу. Больше ничего не нужно."
